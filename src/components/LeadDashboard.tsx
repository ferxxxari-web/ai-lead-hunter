              ...
              <section className="bg-slate-900 rounded-3xl p-8 shadow-2xl relative overflow-hidden text-white">
                ...
                <div className="relative z-10 flex flex-col md:flex-row items-center justify-between gap-6">
                  <div>
                    ...
                    <div className="flex items-baseline gap-4">
                      <div className="text-4xl font-black">
                        未対応{" "}
                        <span className="text-5xl text-teal-400">
                          {
                            posts.filter(
                  ...
                  <button
                    onClick={handleScan}
                    disabled={isScanning}
                    className="w-full md:w-auto px-10 py-5 bg-teal-500 hover:bg-teal-400 text-slate-950 rounded-2xl font-black text-lg transition-all shadow-lg shadow-teal-500/30 active:scale-95 flex items-center justify-center gap-3"
                  >
                    {isScanning ? (
                    ...
                    <div className="bg-slate-50 border border-slate-100 rounded-xl p-6">
                      ...
                      <div className="flex gap-3">
                        <button
                          ...
                          className="flex-1 px-6 py-4 rounded-xl bg-teal-600 text-white font-bold text-sm hover:bg-teal-700 transition-all shadow-md active:scale-95 disabled:opacity-50 disabled:cursor-not-allowed"
                        >
                          {executingId === post.id
                            ? "自動送信中..."
                            : post.status === "replied"
                        ...
                        <button
                          onClick={() => {
                            ...
                            handleStatusChange(post.id, "replied");
                          }}
                          className="px-6 py-4 rounded-xl bg-slate-900 hover:bg-slate-800 text-white font-bold text-sm transition-all shadow-md active:scale-95 flex items-center justify-center gap-2"
                        >
